...
const frontendFolder = path.resolve(__dirname, 'src/main/frontend');
...
const clientSideIndexEntryPoint = path.resolve(__dirname, 'src/main/frontend', 'generated/', 'vaadin.ts');;
